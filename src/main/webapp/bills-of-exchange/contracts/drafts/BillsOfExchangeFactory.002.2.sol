...
* BillsOfExchangeFactory contract address: https://ropsten.etherscan.io/address/...
...
contract Token {
    ...
    * here it will be BillsOfExchangeFactory smart contract address
    */
...
contract BillsOfExchange is BurnableToken {
    ...
    * this can be a name of a company/organisation or of a physical person
    */
    string public drawerName;

    /**
    * Ethereum address of the signer
    * His/her identity have to be verified via Cryptonomica.net smart contract
    */
    ...
    * It can be link to public register like Companies House, or other proof.
    ...
    *  we use string to make possible variants like: 'at sight', 'at sight but not before 2019-12-31'
    ...
    */
    ...
    /**
    * set up new bunch of bills of exchange
    *
...
contract BillsOfExchangeFactory is ManagedContractWithPaidService {
    ...
    */
    constructor() public {
        ...
        require(
            changeCryptonomicaVerificationContractAddress(0x7f05E9807F509281A8db8F8b5230B89a96650087),
            "Cryptonomica Verification Contract address can not be set"
        );

        require(
            setWithdrawalAddress(msg.sender),
            "Withdrawal address can not be set"
        );
    }
    ...
    * @param _timeOfPaymentUnixTime Time when bill payment has to be made, if provided 0, will be the same as time
    * of issue, and bill will be payable 'at sight'
    ...
    */
    ...
    /*
    * arguments to test this function in remix:
    * "Test Company Ltd. bills of exchange, Series TST01", "TST01", 100000000, "EUR",1,"Test Company Ltd, 3 Main Street, London, XY1Z  1XZ, U.K.; company # 12345678","https://beta.companieshouse.gov.uk/company/12345678/officers","at sight, but not before 01 Jan 2021","London, U.K.", "London, U.K."
    */
    ...
    // address _drawerRepresentedBy, // <<< msg.sender
        string memory _linkToSignersAuthorityToRepresentTheDrawer,
    // string calldata _drawee, > the same as drawer
    // address _draweeSignerAddress, > the same as msg.sender
        string memory _timeOfPayment,
        string memory _placeWhereTheBillIsIssued,
        string memory _placeWherePaymentIsToBeMade

    ) public payable returns (bool success) {// if 'external' > "Stack to deep ..." error
        ...
        // not needed to call 'signDisputeResolutionAgreement' because signature is required by 'accept' function
